...
my @macRomanData = (
    ...
    0xC6 => [ 0x2206, "",        "increment" ],  ### No entity
    ...
    0xDE => [ 0xFB01, "",        "Latin small ligature fi" ],  ### No entity
    0xDF => [ 0xFB02, "",        "Latin small ligature fl" ],  ### No entity
    ...
    0xF0 => [ 0xF8FF, "",        "Apple logo" ],  ### No entity
    ...
    0xF5 => [ 0x0131, "",        "Latin small letter dotless i" ],  ### No entity
    0xF6 => [ 0x02C6, "circ",    "modifier letter circumflex accent" ],
    0xF7 => [ 0x02DC, "tilde",   "small tilde" ],
    0xF8 => [ 0x00AF, "macr",    "macron" ],
    0xF9 => [ 0x02D8, "",        "breve" ],  ### No entity
    0xFA => [ 0x02D9, "",        "dot above" ],  ### No entity
    0xFB => [ 0x02DA, "",        "ring above" ],  ### No entity
    0xFC => [ 0x00B8, "cedil",   "cedilla" ],
    0xFD => [ 0x02DD, "",        "double acute accent" ],  ### No entity
    0xFE => [ 0x02DB, "",        "ogonek" ],  ### No entity
    0xFF => [ 0x02C7, "",        "caron" ],  ### No entity
);
